...
\cventry{2018--Present}{Postdoctoral Researcher}{\DPA, \PU}{West Lafayette, IN, USA}{}{%
\begin{itemize}
  ...
  \item Development of the code \texttt{Paramo}: a numerical tool which solves the Fokker-Planck equation by making use of an implicit method.
  \item Work on a model in which a simple model for the blazars sequence has been proposed. An article is being developed out of this project.
  \item A research grant was obtained from the \textit{NASA Fermi Cycle-12 Guest Investigator Program}.
\end{itemize}
}
%
\cventry{2018}{Postdoctoral Research Associate}{\IFMes, \UMSNHes}{Morelia, Mexico}{}{%
\begin{itemize}
  \item Took part in instructive and training activities for graduate students.
  \item Participation in the weekly group meetings for monitoreeing the progress
  of graduate students.
  \item Set the fundamentals for a numerical tool for the evolution of particles
  which solves numerically the Fokker-Planck equation.
\end{itemize}
}
%
...
\begin{itemize}
  ...
  \item Extracted and interpreted data from the simulations of the main characteristics of blazars SEDs, e.g. Compton dominance, synchrotron and Compton peaks, spectral index.
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Systematic exposure graphite samples to microwaves (2.45~GHz).
