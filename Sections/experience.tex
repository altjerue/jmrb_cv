...
\cventry{2017--Present}{Postdoctoral Researcher}{\DPA, \PU}{West Lafayette, IN, USA}{}{%
\begin{itemize}
  \item Development of the code \texttt{Paramo}: a numerical tool which solves
  the Fokker-Planck equation by making use of an implicit method.
\end{itemize}
}
%
