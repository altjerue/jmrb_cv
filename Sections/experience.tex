...
{%
\begin{itemize}
  \item Provide expert-level knowledge in Physics, Astrophysics, and Mathematics to improve models for a top AI research lab.
  \item Assess model reasoning quality, identify failure modes, and provide structured feedback to improve scientific accuracy.
  \item Apply understanding of mathematical foundations to benchmark model performance on complex STEM problems.
\end{itemize}
}
%-----------------------------------
\cventry{}%
